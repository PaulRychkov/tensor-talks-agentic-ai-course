...
async def process_kafka_event(event: KafkaEvent):
    ...
    try:
        ...
        if role_str == "user":
            ...
            # Do NOT log content here — PII check runs later inside the graph
            logger.info(
        ...
        if role_str == "user" and user_message_content:
            ...
            if fixed_message != user_message_content:
                # Do NOT log before/after content — may contain PII
                logger.info(
        ...
        initial_state: AgentState = {
            ...
            "hints_given": 0,
            "tool_calls": 0,
            "clarifications_in_question": 0,
            "evaluations": [],
            "last_decision": None,
            "answer_evaluation": None,
            "agent_decision": None,
            "hint_request": None,
            "skip_question_request": None,
            "generated_response": None,
            "generated_question": None,
            "response_metadata": None,
            "previous_topic_scores": None,
            "processing_steps": [],
            "error": None,
            "retry_count": 0,
        }
...
async def lifespan(app: FastAPI):
    ...
    global llm_client, session_client, redis_client, chat_crud_client, kafka_producer, kafka_consumer, agent_graph
    ...
    chat_crud_client = ChatCrudClient()
    ...
    agent_graph = create_agent_graph(
        llm_client, session_client, redis_client, kafka_producer, chat_crud_client
    )
