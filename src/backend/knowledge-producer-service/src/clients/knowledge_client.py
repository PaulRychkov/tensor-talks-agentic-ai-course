...
class KnowledgeClient:
    ...
    async def create_knowledge(self, knowledge_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Failed to create knowledge", knowledge_id=knowledge_data.get("id"), error=str(e))
            raise

    async def update_knowledge(self, knowledge_id: str, knowledge_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Failed to update knowledge", knowledge_id=knowledge_id, error=str(e))
            raise
